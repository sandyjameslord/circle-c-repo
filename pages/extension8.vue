<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 8: Record Sentences (2)<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
        ...
        <div id='extensionArea'>
            ...
            <div id="textContainer">
                ...
                <span id='currentTextTitle'>Record each of the sentences. Listen to your own voice and the computer's.</span>
...
export default {
    ...
    methods: {
        startRecording() {
            ...
            button.style.animation = "recordingAnimation 2000ms linear 5";
            button.innerHTML = "<br> Recording <br> ...";
            button.style.fontSize = "1.2em";
            button.style.paddingTop = "10px";
            let spacer = document.getElementById("spacer");
            // spacer.style.animation = "none";
            spacer.style.animation = "spacerTimer 10000ms linear 1";
        ...
        makeImageAndTextAppear(number) {
            ...
            mainText.innerHTML = bcSentence;
            currentSelection.innerHTML = bcSentence;
            currentSelection.style.textAlign = "left";

            hiddenBCSentence.innerHTML = bcSentence;
        ...
        readTextOutLoudComputer() {
            let hiddenVocab = document.getElementById("currentBCSentenceInfo");
