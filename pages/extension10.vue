<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 10: Discuss Questions (2)<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
        ...
        <div id='extensionArea'>
            ...
            <div id='nonViewDataContainer'>
                ...
                <p id='currentIndex'></p>
                <audio class="audioClass" id="aud0" controls></audio>
                ...
                <audio class="audioControlClass" id="audioControl0" ></audio>
            ...
            <div id="containerForAbsolutePositionedItems">
                <div id='clickToRecord' @click='startRecording()'>Click to Record</div>
                <div id="domainDisplay">
                    <span id="languageOfTitle">Language of</span>
                    <span id="languageOf">English Language Arts</span>
                </div>
            </div>

            <div id="textContainer">
                <span id='currentSelection'>Current Selection</span>
                <span id='currentTextTitle'>Listen to the question and think about it. Make your own 15 second response.</span>
                <span id="currentText">Click an image below to begin.</span>
                
                <span class="practiceInputEven" id='spacer'></span>
                
                <div id="buttonHolder">
                    <span id="playCurrentTextButton" class='button' @click="readTextOutLoudPerson()">Your Response</span>    
                    <span id="playCurrentTextButton2" class='button' @click="readTextOutLoudComputer()">Listen to the Question</span>    
                </div>
...
export default {
    ...
    mounted () {
        ...
        let receivedBCQuestions = document.getElementsByClassName("smallImageBCQuestion");
        let shownBCQuestions = document.getElementsByClassName("bcQuestionHolder");

        let receivedBCQuestionDomains = document.getElementsByClassName("smallImageBCQuestionDomain");
        let shownBCQuestionDomains = document.getElementsByClassName("bcQuestionDomainHolder");

        // let receivedABQuestions = document.getElementsByClassName("smallImageABQuestion");
        // let shownABQuestions = document.getElementsByClassName("abQuestionHolder");

        // let receivedABQuestionDomains = document.getElementsByClassName("smallImageABQuestionDomain");
        // let shownABQuestionDomains = document.getElementsByClassName("abQuestionDomainHolder");
        ...
        for (let i = 0; i < 10; i++) {
            ...
            shownBCQuestions[i].innerHTML = receivedBCQuestions[i].innerHTML; 
            shownBCQuestionDomains[i].innerHTML = receivedBCQuestionDomains[i].innerHTML; 
            
        }
    },
    methods: {
        startRecording() {
            let button = document.getElementById("clickToRecord");

            button.style.animation = "recordingAnimation 2000ms linear 7.5";
            button.innerHTML = "<br> Recording <br> ...";
            button.style.fontSize = "0.9em";
            button.style.paddingTop = "10px";
            let spacer = document.getElementById("spacer");
            // spacer.style.animation = "none";
            spacer.style.animation = "spacerTimer 15000ms linear 1";
            ...
            setTimeout(function(){ 
                button.innerHTML = "Click to <br> Record";
                button.style.fontSize = "1.0em";
                button.style.paddingTop = "22px";
            }, 15000);
            ...
            // let button = document.getElementById("clickToRecord");
            // // button.style.animation = "none";
            // button.style.animation = "recordingAnimation 2000ms linear 7";
            
            // let spacer = document.getElementById("spacer");
            // // spacer.style.animation = "none";
            // spacer.style.animation = "spacerTimer 14000ms linear 1";
            ...
            navigator.mediaDevices.getUserMedia(constraintObj).then(function (mediaStreamObj) {
                let index = document.getElementById("currentIndex").innerHTML;
                index = index % 10;
                ...
                // console.log("INDEX", index);
                let imageAudioSaveNumber = "audioControl" + (index);

                let audSave = document.getElementById(imageAudioSaveNumber);
                let mediaRecorder = new MediaRecorder(mediaStreamObj);
                let chunks = [];
                mediaRecorder.start();


                setTimeout(function(){ mediaRecorder.stop(); }, 14000);
        ...
        readTextOutLoudPerson() {
            let currentIndex = document.getElementById("currentIndex").innerHTML;
            currentIndex = (currentIndex % 10);
            // console.log("INDEX HERE DOGG:", currentIndex);
            let audios = document.getElementsByClassName("audio");

            let audioControls = document.getElementsByClassName("audioControlClass");

            for (let i = 0; i < 10; i++) {
                if ((currentIndex % 10) == i) {
                    // let currentAudio = audios[i];
                    audioControls[i].play()
                    // console.log(currentAudio.innerHTML - 1);
                    // currentAudio.play();
                }
            }         
        },
        ...
        makeImageAndTextAppear(number) {
            ...
            // let bcSentence = document.getElementById("bcSentence" + number).innerHTML;
            let bcQuestion = document.getElementById("bcQuestion" + number).innerHTML;
            let bcQuestionDomain = document.getElementById("bcQuestionDomain" + number).innerHTML;

            // let abQuestion = document.getElementById("abQuestion" + number).innerHTML;
            // let abQuestionDomain = document.getElementById("abQuestionDomain" + number).innerHTML;
            ...
            // let hiddenBCSentence = document.getElementById("currentBCSentenceInfo");
            // let hiddenABQuestion = document.getElementById("currentABQuestionInfo");
            let hiddenBCQuestion = document.getElementById("currentBCQuestionInfo");
            let hiddenVocab = document.getElementById("currentVocabInfo");
            let hiddenIndex = document.getElementById("currentIndex");
            // let hiddenABQuestionDomain = document.getElementById("currentABQuestionDomain");


            let languageOf = document.getElementById("languageOf");

            // console.log("ab question doain", abQuestion, abQuestionDomain);

            if (bcQuestionDomain == "MA") { languageOf.innerHTML = "Mathematics" }
            else if (bcQuestionDomain == "SC") { languageOf.innerHTML = "Science" }
            else if (bcQuestionDomain == "ELA") { languageOf.innerHTML = "English Language Arts" }
            else if (bcQuestionDomain == "SS") { languageOf.innerHTML = "Social Studies" }
            else if (bcQuestionDomain == "EDL") { languageOf.innerHTML = "Every Day Language" }

            mainText.innerHTML = bcQuestion;
            currentSelection.innerHTML = bcQuestion;
            currentSelection.style.textAlign = "left";
            currentSelection.style.fontSize = "1.1em";
            // currentSelection.style.paddingTop = "80px";
            currentSelection.style.paddingLeft = "10px";
            
            currentSelection.innerHTML = "<br><br><br>" + currentSelection.innerHTML;
            // currentSelection.style.height = "360px";

            

            let domainDisplay = document.getElementById("domainDisplay");
            domainDisplay.style.visibility = "visible";


            hiddenBCQuestion.innerHTML = bcQuestion;
        ...
        readTextOutLoudComputer() {
            let hiddenVocab = document.getElementById("currentABQuestionInfo");

            let word = hiddenVocab.innerHTML;
...
#languageOf {
    ...
    padding-left: 6px;
    padding-right: 6px;
    border-bottom: 4px solid rgba(100, 80, 210, 1);
    margin: auto;
    width: 200px;
...
#clickToRecord{
    ...
    height: 80px;
    width: 80px;
    background-image: radial-gradient(salmon, salmon, lavender,lavender, lavender, lavender, red, red, red, black);
    border-radius: 50%;
    text-align: center;
    font-size: 1.0em;
    padding-top: 22px;
    ...
    /* animation: recordingAnimation 1500ms linear infinite; */
}

@keyframes recordingAnimation {
    0% {
        background-image: radial-gradient(salmon, salmon, lavender,lavender, lavender, lavender, red, red, red);
        color: black;
        /* transform: scale(1); */
    }
    50% {
        background-image: radial-gradient(red, red, red,red, red, red, red, red, red);
        color: white;
        /* transform: scale(1.2); */
    }
    100% {
...
#spacer {
    background-image: linear-gradient(to right,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan);
    margin-left: 20px;
    ...
    height: 250px;
    font-size: 2em;
    /* animation: spacerTimer 14000ms linear forwards; */
}

@keyframes spacerTimer {
    0% {
        background-image: linear-gradient(to right,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    10% {
        background-image: linear-gradient(to right,darkgreen, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    20% {
        background-image: linear-gradient(to right,darkgreen, darkgreen, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    30% {
        background-image: linear-gradient(to right,salmon, darkgreen, darkgreen,lightcyan, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    40% {
        background-image: linear-gradient(to right,salmon, salmon, darkgreen,darkgreen, lightcyan, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    50% {
        background-image: linear-gradient(to right,salmon, salmon, salmon,darkgreen, darkgreen, lightcyan,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    60% {
        background-image: linear-gradient(to right,salmon, salmon, salmon,salmon, darkgreen, darkgreen,lightcyan, lightcyan, lightcyan,lightcyan);
    }
    70% {
        background-image: linear-gradient(to right,salmon, salmon, salmon,salmon, salmon, darkgreen,darkgreen, lightcyan, lightcyan,lightcyan);
    }
    80% {
        background-image: linear-gradient(to right,salmon, salmon, salmon,salmon, salmon, salmon,darkgreen, darkgreen, lightcyan,lightcyan);
    }
    90% {
        background-image: linear-gradient(to right,salmon, salmon, salmon,salmon, salmon, salmon,salmon, darkgreen, darkgreen,lightcyan);
    }
    100% {
        background-image: linear-gradient(to right,salmon, salmon, salmon,salmon, salmon, salmon,salmon, salmon, darkgreen,darkgreen);
    }
}
