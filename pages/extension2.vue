<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 2: Practice Words<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
        ...
        <div id='extensionArea'>
            ...
            <div id="textContainer">
                ...
                <span id='currentTextTitle'>Say the word before and after typing.</span>
