<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 3: Practice Sentences (1)<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
...
export default {
    ...
    methods: {
        checkIfCorrect() {
            ...
            let abSentence = document.getElementById("currentABSentenceInfo");
            ...
            if (input1.value == abSentence.textContent && abSentence.textContent != "") {
                input1.style.backgroundColor = "lightgreen";
            } else {
                input1.style.backgroundColor = "lightcyan";
            }
            if (input2.value == abSentence.textContent && abSentence.textContent != "") {
                input2.style.backgroundColor = "lightgreen";
            } else {
                input2.style.backgroundColor = "lightcyan";
            }

            if (input3.value == abSentence.textContent && abSentence.textContent != "") {
                input3.style.backgroundColor = "lightgreen";
            } else {
                input3.style.backgroundColor = "lightcyan";
            }

            if (input4.value == abSentence.textContent && abSentence.textContent != "") {
                input4.style.backgroundColor = "lightgreen";
            } else {
                input4.style.backgroundColor = "lightcyan";
            }

            let abSentences = document.getElementsByClassName("abSentenceHolder");
        ...
        makeImageAndTextAppear(number) {
            ...
            currentSelection.style.fontSize = "1.3em";
            currentSelection.style.paddingTop = "8px";
