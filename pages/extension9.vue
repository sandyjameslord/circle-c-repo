<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 9: Discuss Questions (1)<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
...
export default {
    ...
    mounted () {
        ...
        // let receivedBCSentences = document.getElementsByClassName("smallImageBCSentence");
        // let shownBCSentences = document.getElementsByClassName("bcSentenceHolder");
        ...
        for (let i = 0; i < 10; i++) {
            ...
            shownABQuestions[i].innerHTML = receivedABQuestions[i].innerHTML; 
            shownABQuestionDomains[i].innerHTML = receivedABQuestionDomains[i].innerHTML; 
            // shownBCSentences[i].innerHTML = receivedBCSentences[i].innerHTML; 
    ...
    methods: {
        ...
        makeImageAndTextAppear(number) {
            ...
            if (abQuestionDomain == "MA") { languageOf.innerHTML = "Mathematics" }
            else if (abQuestionDomain == "SC") { languageOf.innerHTML = "Science" }
            else if (abQuestionDomain == "ELA") { languageOf.innerHTML = "English Language Arts" }
            else if (abQuestionDomain == "SS") { languageOf.innerHTML = "Social Studies" }
            else if (abQuestionDomain == "EDL") { languageOf.innerHTML = "Every Day Language" }

            mainText.innerHTML = abQuestion;
            currentSelection.innerHTML = abQuestion;
            ...
            hiddenABQuestion.innerHTML = abQuestion;
