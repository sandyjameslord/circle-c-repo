<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 7: Record Sentences (1)<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
        ...
        <div id='extensionArea'>
            ...
            <div id="textContainer">
                ...
                <span id='currentTextTitle'>Record yourself saying the sentences. Listen to your own voice and the computer's.</span>
                <span id="currentText">Click an image below to begin.</span>
                
                <span class="practiceInputEven" id='spacer'></span>
                
                <div id="buttonHolder">
                    <span id="playCurrentTextButton" class='button' @click="readTextOutLoudPerson()">Your Own Voice</span>    
                    <span id="playCurrentTextButton2" class='button' @click="readTextOutLoudComputer()">Computer's Voice</span>    
                </div>
...
export default {
    ...
    mounted () {
        ...
        let receivedABSentences = document.getElementsByClassName("smallImageABSentence");
        let shownABSentences = document.getElementsByClassName("abSentenceHolder");
        ...
        for (let i = 0; i < 10; i++) {
            ...
            shownABSentences[i].innerHTML = receivedABSentences[i].innerHTML; 
    ...
    methods: {
        startRecording() {
            ...
            button.style.animation = "recordingAnimation 2000ms linear 3";
            button.innerHTML = "<br> Recording <br> ...";
            button.style.fontSize = "1.2em";
            button.style.paddingTop = "10px";
            let spacer = document.getElementById("spacer");
            // spacer.style.animation = "none";
            spacer.style.animation = "spacerTimer 6000ms linear 1";
        ...
        readTextOutLoudComputer() {
            let hiddenVocab = document.getElementById("currentABSentenceInfo");
