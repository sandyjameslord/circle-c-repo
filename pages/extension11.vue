<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 11: Discuss Your Ideas<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
        ...
        <div id='extensionArea'>
            ...
            <div id="containerForAbsolutePositionedItems">
                <div id='clickToRecord' @click='startRecording()'>Click to <br> Record</div>
            </div>

            <div id="textContainer">
                <span id='currentSelection'>Current Selection</span>
                <span id='currentTextTitle'>What would you like to say? What else is there to point out? You have 15 seconds.</span>
...
export default {
    ...
    methods: {
        ...
        readTextOutLoudComputer() {
            let hiddenVocab = document.getElementById("currentText");
