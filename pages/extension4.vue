<template>
    <div>
        <div id='header'>
            ...
            <p id="themeName">Extension 4: Practice Sentence (2)<span id='thisThemeName'> {{ this.theme }}, Unit {{ this.unit }} </span></p>
        </div>
        ...
        <div id='extensionArea'>
            ...
            <div id="textContainer">
                ...
                <span id='currentTextTitle'>Say the sentence before and after typing.</span>
                <span id="currentText">Click an image below to begin.</span>
                <textarea class="practiceInputEven" id="practiceInput1" type="text"  @keyup="checkIfCorrect()" placeholder="..."></textarea>
                <textarea class="practiceInputOdd" id="practiceInput2" type="text" @keyup="checkIfCorrect()" placeholder=""></textarea>
...
export default {
    ...
    methods: {
        checkIfCorrect() {
            ...
            let bcSentence = document.getElementById("currentBCSentenceInfo");
            // let vocab = document.getElementById("currentVocabInfo");
            let index = document.getElementById("currentIndex");
            // console.log("vocab.textcontent::", vocab.textContent, "::")

            if (input1.value == bcSentence.textContent && bcSentence.textContent != "") {
                input1.style.backgroundColor = "lightgreen";
            } else {
                input1.style.backgroundColor = "lightcyan";
            }
            if (input2.value == bcSentence.textContent && bcSentence.textContent != "") {
                input2.style.backgroundColor = "lightgreen";
            } else {
                input2.style.backgroundColor = "lightcyan";
            }

            // if (input3.value == bcSentence.textContent && bcSentence.textContent != "") {
            //     input3.style.backgroundColor = "lightgreen";
            // } else {
            //     input3.style.backgroundColor = "lightcyan";
            // }

            // if (input4.value == bcSentence.textContent && bcSentence.textContent != "") {
            //     input4.style.backgroundColor = "lightgreen";
            // } else {
            //     input4.style.backgroundColor = "lightcyan";
            // }

            let bcSentences = document.getElementsByClassName("bcSentenceHolder");
        ...
        makeImageAndTextAppear(number) {
            ...
            currentSelection.style.fontSize = "1.4em";
            currentSelection.style.paddingTop = "10px";
            currentSelection.style.paddingLeft = "8px";
            currentSelection.style.textAlign = "left";
            // currentSelection.style.paddingBottom = "8px";
